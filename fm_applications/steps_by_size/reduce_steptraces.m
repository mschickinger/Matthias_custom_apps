function [steps, ex_int, arxv, GO_ON] = reduce_steptraces(trace, varargin)
    ...
    a1 = uicontrol(bg, 'Style', 'Pushbutton', 'Position', [30 90 140 50],...
        'String', actionlist{1}, 'Callback', @reduce, 'FontSize', 16);

    a2 = uicontrol(bg, 'Style', 'Pushbutton', 'Position', [200 90 140 50],...
        'String', actionlist{2}, 'Callback', @go_back, 'FontSize', 16);

    a3 = uicontrol(bg, 'Style', 'Pushbutton', 'Position', [1250 90 260 50],...
        'String', actionlist{3}, 'Callback', @done, 'FontSize', 16);
    
    a4 = uicontrol(bg, 'Style', 'Pushbutton', 'Position', [370 90 140 50],...
         'String', actionlist{4}, 'Callback', @finer, 'FontSize', 16);
     
    a5 = uicontrol(bg, 'Style', 'Pushbutton', 'Position', [710 90 140 50],...
         'String', actionlist{5}, 'Callback', @coarser, 'FontSize', 16);
     
    a6 = uicontrol(bg, 'Style', 'Pushbutton', 'Position', [930 90 140 50],...
         'String', actionlist{6}, 'Callback', @exclude, 'FontSize', 16);
    
    a7 = uicontrol(bg, 'Style', 'Pushbutton', 'Position', [1090 90 140 50], ...
        'String', actionlist{7}, 'Callback', @reinclude, 'FontSize', 16);
    
    a8 = uicontrol(bg, 'Style', 'Pushbutton', 'Position', [1250 25 260 50],...
        'String', actionlist{8}, 'Callback', @abort, 'FontSize', 16);
    
    at = uicontrol(bg, 'Style', 'Text', 'Position', [540 80 140 50], 'String', ...
        ['Threshold for first reduction: ' num2str(arxv.threshs(1))], 'FontSize', 16);
    set(bg, 'Visible', 'on')
