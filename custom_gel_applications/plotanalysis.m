...
%anzahl stellen für oldmean, oldstd
back=200;
...
%              end
    ...
    %wenn lange genug im zustand, oldmean über "back"werte
    if  counter>back
        ...
        %möglich und gespeichertem mittelwert
        if state==2
...
if newmean>oldmean+a1*oldstandard && abs(newmean-savedhighmean)<b1*savedhighstd
     ...
     %wenn blöd geswitcht nicht speichern
...
% bei den beiden nochmal drüberschauen, parameter noch nicht gut genug
